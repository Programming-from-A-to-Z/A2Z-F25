...
- 🧠 [Mixedbread Embedding Models](https://huggingface.co/collections/mixedbread-ai/eming-series)
- 💻 [Comparison Matrix](https://editor.p5js.org/a2zitp/sketches/PoCdx9WBd)
- 💻 [Semantic Search Text](https://editor.p5js.org/a2zitp/sketches/5XQmxHdnS)

### Retrieval Augmented Generation

- 💻 [Node.js + Ollama + Transformers.js RAG Example](https://github.com/Programming-from-A-to-Z/Ollama-Context-RAG)

### Zero Shot Models

- 💻 [Zero Shot Image Classification](https://editor.p5js.org/a2zitp/sketches/GRyILD0L8) - uses CLIP multi-modal model
- 💻 [Zero Shot Object Detection](https://editor.p5js.org/a2zitp/sketches/kcNMe04mT)

### CLIP image + text embeddings

- 💻 [Simple Text Semantic Search with 10 images](https://editor.p5js.org/a2zitp/sketches/1i-ne5nPh)
- 💻 [Simple Image Semantic Search with 10 images](https://editor.p5js.org/a2zitp/sketches/fTb39Ieok)
